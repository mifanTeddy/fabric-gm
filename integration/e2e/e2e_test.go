...
import (
	...
	"github.com/hyperledger/fabric-gm/integration/nwo"
	"github.com/hyperledger/fabric-gm/integration/nwo/commands"
	"github.com/hyperledger/fabric-gm/protos/common"
	protosorderer "github.com/hyperledger/fabric-gm/protos/orderer"
...
var _ = Describe("EndToEnd", func() {
	...
	BeforeEach(func() {
		...
		chaincode = nwo.Chaincode{
			Name:    "mycc",
			Version: "0.0",
			Path:    "github.com/hyperledger/fabric-gm/integration/chaincode/simple/cmd",
