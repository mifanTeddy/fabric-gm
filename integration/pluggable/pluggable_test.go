...
import (
	...
	"github.com/hyperledger/fabric-gm/integration/nwo/fabricconfig"
...
func compilePlugin(pluginType string) string {
	...
	cmd := exec.Command(
		...
		"-o", pluginFilePath,
		fmt.Sprintf("github.com/hyperledger/fabric-gm/integration/pluggable/testdata/plugins/%s", pluginType),
	)
