...
PROJECT_NAME = hyperledger/fabric-gm
endif
...
$(BUILD_DIR)/docker/bin/%: $(PROJECT_FILES)
	...
	@$(DRUN) \
		-v $(abspath $(BUILD_DIR)/docker/bin):/Users/mifan/gopath/bin \
		-v $(abspath $(BUILD_DIR)/docker/$(TARGET)/pkg):/Users/mifan/gopath/pkg \
...
$(BUILD_DIR)/docker/gotools: gotools.mk
	...
	@mkdir -p $@/bin $@/obj
	@$(DRUN) \
		-v $(abspath $@):/Users/mifan/gotools \
		-w/Users/mifan/go/src/$(PKGNAME) \
		$(BASE_DOCKER_NS)/fabric-baseimage:$(BASE_DOCKER_TAG) \
		make -f gotools.mk GOTOOLS_BINDIR=/Users/mifan/gotools/bin GOTOOLS_GOPATH=/Users/mifan/gotools/obj
