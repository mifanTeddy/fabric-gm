...
if [ -d "${GOPATH}/src/github.com/hyperledger/fabric-gm/.build" ]; then
    export GOCACHE="${GOPATH}/src/github.com/hyperledger/fabric-gm/.build/go-cache"
fi
...
context_whitelist=(
    "^github.com/hyperledger/fabric-gm/protos(:|/.*:)"
    "^github.com/hyperledger/fabric-gm/orderer/common/broadcast/mock:"
    "^github.com/hyperledger/fabric-gm/common/grpclogging/fakes:"
    "^github.com/hyperledger/fabric-gm/common/grpclogging/testpb:"
    "^github.com/hyperledger/fabric-gm/common/grpcmetrics/fakes:"
    "^github.com/hyperledger/fabric-gm/common/grpcmetrics/testpb:"
)
