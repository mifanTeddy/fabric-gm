...
//go:generate protoc --proto_path=$GOPATH/src/github.com/hyperledger/fabric-gm/common/grpclogging/testpb --go_out=plugins=grpc:$GOPATH/src $GOPATH/src/github.com/hyperledger/fabric-gm/common/grpclogging/testpb/echo.proto
