...
import (
	...
	"github.com/hyperledger/fabric-gm/core/chaincode/lifecycle/mock"
	"github.com/hyperledger/fabric-gm/core/chaincode/shim"
	lb "github.com/hyperledger/fabric-gm/protos/peer/lifecycle"
)
...
var _ = Describe("SCC", func() {
	...
	Describe("Path", func() {
		It("returns the path", func() {
			Expect(scc.Path()).To(Equal("github.com/hyperledger/fabric-gm/core/chaincode/lifecycle"))
		})
	})
