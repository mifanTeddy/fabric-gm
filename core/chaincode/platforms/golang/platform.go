...
import (
	...
	"github.com/hyperledger/fabric-gm/core/chaincode/platforms/util"
...
func (goPlatform *Platform) GetDeploymentPayload(path string) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/hyperledger/fabric-gm/core/chaincode/shim": true,
		"github.com/hyperledger/fabric-gm/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/hyperledger/fabric-gm/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
