...
import (
	...
	"github.com/hyperledger/fabric-gm/core/config/configtest"
...
func Test_findSource(t *testing.T) {
	...
	source, err = findSource(gopath, "github.com/hyperledger/fabric-gm/peer")
	if err != nil {
		t.Errorf("failed to find source: %s", err)
	}

	if _, ok := source["src/github.com/hyperledger/fabric-gm/peer/main.go"]; !ok {
...
func Test_DeploymentPayload(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("github.com/hyperledger/fabric-gm/examples/chaincode/go/example02/cmd")
...
func Test_DeploymentPayloadWithStateDBArtifacts(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("github.com/hyperledger/fabric-gm/examples/chaincode/go/marbles02")
	assert.NoError(t, err)
...
func Test_decodeUrl(t *testing.T) {
	path := "http://github.com/hyperledger/fabric-gm/examples/chaincode/go/map"
...
func TestValidatePath(t *testing.T) {
	...
	var tests = []struct {
		...
		{path: "http://github.com/hyperledger/fabric-gm/examples/chaincode/go/map", succ: true},
		{path: "https://github.com/hyperledger/fabric-gm/examples/chaincode/go/map", succ: true},
		{path: "github.com/hyperledger/fabric-gm/examples/chaincode/go/map", succ: true},
		{path: "github.com/hyperledger/fabric-gm/bad/chaincode/go/map", succ: false},
		{path: ":github.com/hyperledger/fabric-gm/examples/chaincode/go/map", succ: false},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{gopath: defaultGopath, path: "github.com/hyperledger/fabric-gm/examples/chaincode/go/map", succ: true},
		{gopath: defaultGopath, path: "github.com/hyperledger/fabric-gm/examples/bad/go/map", succ: false},
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	tests := []struct {
		...
		{gopath: defaultGopath, spec: spec{CCName: "map", Path: "github.com/hyperledger/fabric-gm/examples/chaincode/go/map", SuccessExpected: true, RealGen: true}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadPath", Path: "github.com/hyperledger/fabric-gm/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric-gm/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadMode", Path: "github.com/hyperledger/fabric-gm/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric-gm/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false}},
