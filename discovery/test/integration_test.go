...
import (
	...
	bccsp "github.com/hyperledger/fabric-gm/bccsp/utils"
	...
	policiesmocks "github.com/hyperledger/fabric-gm/common/mocks/policies"
	...
	"github.com/hyperledger/fabric-gm/core/cclifecycle"
	lifecyclemocks "github.com/hyperledger/fabric-gm/core/cclifecycle/mocks"
	...
	disc "github.com/hyperledger/fabric-gm/discovery/client"
	...
	"github.com/hyperledger/fabric-gm/discovery/support/mocks"
	"github.com/hyperledger/fabric-gm/gossip/api"
	gcommon "github.com/hyperledger/fabric-gm/gossip/common"
	gdisc "github.com/hyperledger/fabric-gm/gossip/discovery"
	"github.com/hyperledger/fabric-gm/msp"
	"github.com/hyperledger/fabric-gm/protos/common"
	. "github.com/hyperledger/fabric-gm/protos/discovery"
	"github.com/hyperledger/fabric-gm/protos/gossip"
	msprotos "github.com/hyperledger/fabric-gm/protos/msp"
...
func buildBinaries() error {
	var err error
	cryptogen, err = gexec.Build("github.com/hyperledger/fabric-gm/common/tools/cryptogen")
	if err != nil {
		return errors.WithStack(err)
	}

	idemixgen, err = gexec.Build("github.com/hyperledger/fabric-gm/common/tools/idemixgen")
	if err != nil {
		return errors.WithStack(err)
	}
	return nil
