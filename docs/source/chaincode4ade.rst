...
Every chaincode program must implement the ``Chaincode`` interface:
  ...
  - `Go <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#Chaincode>`__
...
The other interface in the chaincode "shim" APIs is the ``ChaincodeStubInterface``:
  ...
  - `Go <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStubInterface>`__
...
`Chaincode interface <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#Chaincode>`_
...
`peer protobuf package <https://godoc.org/github.com/hyperledger/fabric-gm/protos/peer>`_.
...
.. code:: go
    ...
    import (
    	...
    	"github.com/hyperledger/fabric-gm/protos/peer"
    )
...
`ChaincodeStubInterface.GetStringArgs <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStub.GetStringArgs>`_
...
`ChaincodeStubInterface.PutState <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStub.PutState>`_
...
`ChaincodeStubInterface.GetFunctionAndParameters <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStub.GetFunctionAndParameters>`_
...
the `ChaincodeStubInterface.PutState <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStub.PutState>`_
and `ChaincodeStubInterface.GetState <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#ChaincodeStub.GetState>`_
...
`shim.Start <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim#Start>`_
...
.. code:: bash
  ...
  go get -u github.com/hyperledger/fabric-gm/core/chaincode/shim
  go build
...
.. code:: bash
  ...
  root@d2629980e76b:/Users/mifan/gopath/src/chaincode#
...
See the `client identity (CID) library documentation <https://github.com/hyperledger/fabric-gm/blob/master/core/chaincode/shim/ext/cid/README.md>`_
for more details.
...
the `entities extension <https://github.com/hyperledger/fabric-gm/tree/master/core/chaincode/shim/ext/entities>`__
...
`Encc Example <https://github.com/hyperledger/fabric-gm/tree/master/examples/chaincode/go/enccc_example>`__
