...
`configtx.yaml`. You can look at a [sample `configtx.yaml` file here](http://github.com/hyperledger/fabric-gm/blob/release-1.2/sampleconfig/configtx.yaml).
...
followed by a string. To see what this looks like, reference this [sample configtx.yaml file](https://github.com/hyperledger/fabric-gm/blob/release-1.2/sampleconfig/configtx.yaml).
