...
* `Fabric v1.4.0 release notes <https://github.com/hyperledger/fabric-gm/releases/tag/v1.4.0>`_.
* `Fabric v1.4.1 release notes <https://github.com/hyperledger/fabric-gm/releases/tag/v1.4.1>`_.
