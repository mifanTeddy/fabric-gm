...
.. code:: bash
    ...
    peer chaincode package -n mycc -p github.com/hyperledger/fabric-gm/examples/chaincode/go/example02/cmd -v 0 -s -S -i "AND('OrgA.admin')" ccpack.out
...
The
`ChaincodeDeploymentSpec <https://github.com/hyperledger/fabric-gm/blob/master/protos/peer/chaincode.proto#L78>`_
may be optionally be signed by the collective owners to create a
`SignedChaincodeDeploymentSpec <https://github.com/hyperledger/fabric-gm/blob/master/protos/peer/signed_cc_dep_spec.proto#L26>`_
(or SignedCDS). The SignedCDS contains 3 elements:
  ...
  3. The list of chaincode owners, defined by means of
     `Endorsement <https://github.com/hyperledger/fabric-gm/blob/master/protos/peer/proposal_response.proto#L111>`_.
...
<https://github.com/hyperledger/fabric-gm/blob/master/protos/peer/proposal.proto#L104>`_
...
`ENDORSER_TRANSACTION <https://github.com/hyperledger/fabric-gm/blob/master/protos/common/common.proto#L42>`_.
...
register with a `fixed set of parameters <https://github.com/hyperledger/fabric-gm/blob/master/core/scc/importsysccs.go>`_
...
1. `LSCC <https://github.com/hyperledger/fabric-gm/tree/master/core/scc/lscc>`_
   Lifecycle system chaincode handles lifecycle requests described above.
2. `CSCC <https://github.com/hyperledger/fabric-gm/tree/master/core/scc/cscc>`_
   Configuration system chaincode handles channel configuration on the peer side.
3. `QSCC <https://github.com/hyperledger/fabric-gm/tree/master/core/scc/qscc>`_
