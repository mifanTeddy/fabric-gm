...
and ``PutPrivateData()``, which can be found `here <https://github.com/hyperledger/fabric-gm/blob/master/core/chaincode/shim/interfaces.go#L179>`_.
...
Use the `peer chaincode install <http://hyperledger-fabric.readthedocs.io/en/master/commands/peerchaincode.html?%20chaincode%20instantiate#peer-chaincode-install>`__ command to install the Marbles chaincode on each peer.
 ...
 ``root@81eac8493633:/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer#``
 ...
 3. Use the CLI to switch to Org2. Copy and paste the following block of
    ...
    .. code:: bash
       ...
       export PEER0_ORG2_CA=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
       export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG2_CA
       export CORE_PEER_MSPCONFIGPATH=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
...
example.
 ...
 .. code:: bash
   ...
   export ORDERER_CA=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
submit a request to add a marble:
 ...
 .. code:: bash
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
    export PEER0_ORG1_CA=/Users/mifan/gopath/src/github.com/hyperledger/fabric-gm/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
 ...
 .. code:: bash
   ...
   peer chaincode invoke -o orderer.example.com:7050 --tls --cafile/Users/mifan/go/src/github.com/hyperledger/fabric-gm/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C mychannel -n marblesp -c '{"Args":["initMarble"]}'  --transient "{\"marble\":\"$MARBLE\"}"
