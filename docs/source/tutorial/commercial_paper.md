...
```
(magnetocorp admin)$ docker exec cliMagnetoCorp peer chaincode install -n papercontract -v 0 -p/Users/mifan/go/src/github.com/contract -l node
...
`/Users/mifan/gopath/src/github.com/contract`. This path has been mapped to the local
...
volumes:
    - ...
    - ./../../../../organization/magnetocorp:/Users/mifan/gopath/src/github.com/
    - ...
```

See how the `volume` directive maps `organization/magnetocorp` to
`/Users/mifan/gopath/src/github.com/` providing this container access to your local file
