...
<https://github.com/hyperledger/fabric-gm/blob/master/docs/source/dev-setup/headers.txt>`__.

We have tried to make it as easy as possible to make contributions. This
applies to how we handle the legal aspects of contribution. We use the
same approach—the `Developer's Certificate of Origin 1.1
(DCO) <https://github.com/hyperledger/fabric-gm/blob/master/docs/source/DCO1.1.txt>`__—that the Linux® Kernel
