...
A set of `shim APIs <https://godoc.org/github.com/hyperledger/fabric-gm/core/chaincode/shim>`_
...
``transient`` field by calling the `GetTransient() API <https://github.com/hyperledger/fabric-gm/blob/8b3cbda97e58d1a4ff664219244ffd1d89d7fba8/core/chaincode/shim/interfaces.go#L315-L321>`_.
...
.. note:: If you would like more granular access control, you can set
          ...
          `chaincode library <https://github.com/hyperledger/fabric-gm/tree/master/core/chaincode/shim/ext/cid>`__ .
