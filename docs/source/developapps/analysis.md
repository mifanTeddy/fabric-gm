...
If golang is used as a chaincode language, the [client identity chaincode library](https://github.com/hyperledger/fabric-gm/blob/master/core/chaincode/shim/ext/cid/README.md)
